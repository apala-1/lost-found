...
class UpdateBatchUsecaseParams extends Equatable {
  ...
  const UpdateBatchUsecaseParams({ required this.batchId, required this.batchName, this.status });
...
class UpdateBatchUsecase implements UsecaseWithParams<bool, UpdateBatchUsecaseParams> {
  ...
  Future<Either<Failure, bool>> call(UpdateBatchUsecaseParams params) {
    // TODO: implement call
    final batch = BatchEntity(batchId: params.batchId, batchName: params.batchName, status: params.status,);
