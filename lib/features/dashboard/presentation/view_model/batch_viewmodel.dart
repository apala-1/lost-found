...
import 'package:lost_n_found/features/dashboard/presentation/state/batch_state.dart';
...
class BatchViewmodel extends Notifier<BatchState> {
  ...
  Future<void> getAllBatches() async {
    ...
    result.fold(
      ...
      (batches) { state = state.copyWith( status: BatchStatus.loaded, batches: batches, ); },
    );
  }
}